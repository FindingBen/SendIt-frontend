...
const ConfirmProductImport = ({ showModal, onClose, importConfirm }) => {
...
const handleConfirm = async () => {
    setLoading(true);
    try {
      await importConfirm(); // Make sure sendConfirm returns a Promise!
      setLoading(false);
      closeModal();
    } catch (err) {
      setLoading(false);
            ...
            <div className="relative w-auto mx-auto max-w-3xl">
              ...
              <div className="relative flex flex-col w-full bg-ngrokGray">
                ...
                <div className="flex flex-row text-2xl font-euclid p-6 text-slate-400">
                  <p>Shopify products sync confirmation</p>
                  <svg
                ...
                <div className="relative p-6 flex-auto">
                  <p className="my-4 text-slate-500 text-lg leading-relaxed font-euclid">
                    You are about to import your shopify products, from now on, your store is synced with our app. Everytime you add new product, it will be added here.
                  </p>
                </div>
                {/*footer*/}
...
export default ConfirmProductImport