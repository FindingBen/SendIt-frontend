...
const ButtonAnalytics = ({ sms }) => {
  return (
    <div className="p-2 bg-gradient-to-b from-lighterMainBlue to-mainBlue border-2 border-gray-800 w-[92%] h-full flex-1 rounded-2xl relative">
      {sms?.has_button == false ? (
        <div className="grid grid-cols-2 grid-rows-2 mt-4">
          <div className="flex flex-col p-1 relative">
            {sms?.button_1_name ? (
              <div className="p-2 flex flex-row items-center h-[100px] w-[170px] rounded-2xl bg-gradient-to-b from-lighterMainBlue to-mainBlue border-2 border-gray-800 relative">
                <div className="flex items-start p-2">
                  {sms ? (
                    <motion.div
                      ...
                      className="text-white absolute top-5 text-2xl font-semibold ml-2 duration-300 opacity-100 transition-opacity"
                    >
                      {sms?.button_1}
                    </motion.div>
                  ) : (
          ...
          <div className="flex flex-col p-1 relative">
            {sms?.button_3_name ? (
              <div className="p-2 flex flex-row items-center h-[100px] w-[170px] rounded-2xl bg-gradient-to-b from-lighterMainBlue to-mainBlue border-2 border-gray-800 relative">
                ...
                <p className="text-white text-sm font-semibold text-justify absolute right-2 bottom-2">
                  {sms?.button_3_name}
                </p>
