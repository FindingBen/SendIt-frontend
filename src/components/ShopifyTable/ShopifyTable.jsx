...
const ShopifyTable = ({ products }) => {
  ...
  return (
    <div class="relative w-full h-[50%] lg:h-[65%] overflow-y-auto shadow-md sm:rounded-lg">
      <div class="text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
        <div class="text-xs grid grid-cols-4 border-b border-gray-800 text-gray-700 uppercase bg-gray-700 dark:text-gray-400">
